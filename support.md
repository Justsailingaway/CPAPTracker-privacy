# CPAP Tracker Support

## Need Help?

We're here to help you get the most out of CPAP Tracker. Below you'll find answers to common questions and ways to reach us.
...
**How do I add a new consumable?**
Go to the Consumables tab and tap the "+" button. Select the type of consumable and set a replacement interval.

**What does "Due Soon" and "Overdue" mean?**
- **Due Soon**: The consumable is within 20% of its replacement date.
- **Overdue**: The replacement date has passed. Tap the consumable to replace it.

**Can I track more than 5 consumables?**
The free version supports up to 5 consumables. Upgrade to Pro for unlimited tracking.
...
The Cleaning tab shows daily, weekly, and monthly tasks based on the consumables you're tracking. Tap a task to mark it complete and earn XP.
...
Go to Settings and toggle off "iCloud Sync." Your data stays on each device but stops syncing new changes.
...
- PDF export of your equipment history
- Ad-free experience
- All future Pro features

**Is Pro a subscription?**
No. Pro is a one-time purchase with lifetime access.
...
Pro users can export a PDF report from Settings. This includes your consumables and replacement history.

**How do I delete all my data?**
Go to Settings and use "Reset All Data" to permanently delete everything. If you use iCloud sync, you may also need to delete data from your iCloud settings.

## Contact Us

If you have a question not covered above, or need to report a bug:

**Email**: [justsailingaway+cpaptracker@gmail.com](mailto:justsailingaway+cpaptracker@gmail.com)

We typically respond within 48 hours.

---

[Privacy Policy](https://justsailingaway.github.io/CPAPTracker-privacy/) | [Terms of Service](https://justsailingaway.github.io/CPAPTracker-privacy/terms)
